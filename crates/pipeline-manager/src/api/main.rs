...
"#
    ...
    components(schemas(
        ...
        opendera_types::pipeline_diff::ProgramDiff,
        opendera_types::pipeline_diff::PipelineDiff,
        opendera_types::runtime_status::RuntimeStatus,
        opendera_types::runtime_status::RuntimeDesiredStatus,
        opendera_types::runtime_status::BootstrapPolicy,
        ...
        // Dataflow IR
        opendera_ir::Dataflow,
        opendera_ir::MirNode,
        opendera_ir::CalcitePlan,
        opendera_ir::CalciteId,
        opendera_ir::MirInput,
        opendera_ir::Rel,
        opendera_ir::Operand,
        opendera_ir::Op,
        opendera_ir::Condition,
        opendera_types::config::ProgramIr,
        ...
        // From the opendera-types crate
        opendera_types::config::PipelineConfig,
        opendera_types::config::MultihostConfig,
        opendera_types::config::StorageConfig,
        opendera_types::config::StorageCacheConfig,
        opendera_types::config::StorageOptions,
        opendera_types::config::StorageBackendConfig,
        opendera_types::config::SyncConfig,
        opendera_types::config::StartFromCheckpoint,
        opendera_types::config::FileBackendConfig,
        opendera_types::config::StorageCompression,
        opendera_types::config::RuntimeConfig,
        opendera_types::config::FtConfig,
        opendera_types::config::InputEndpointConfig,
        opendera_types::config::ConnectorConfig,
        opendera_types::config::OutputBufferConfig,
        opendera_types::config::OutputEndpointConfig,
        opendera_types::config::TransportConfig,
        opendera_types::config::FormatConfig,
        opendera_types::config::ResourceConfig,
        opendera_types::config::ObjectStorageConfig,
        opendera_types::config::FtModel,
        opendera_types::config::PipelineTemplateConfig,
        opendera_types::config::DevTweaks,
        opendera_types::config::dev_tweaks::BufferCacheStrategy,
        opendera_types::config::dev_tweaks::BufferCacheAllocationStrategy,
        opendera_types::config::dev_tweaks::MergerType,
        opendera_types::transport::adhoc::AdHocInputConfig,
        opendera_types::transport::clock::ClockConfig,
        opendera_types::transport::file::FileInputConfig,
        opendera_types::transport::file::FileOutputConfig,
        opendera_types::transport::http::HttpInputConfig,
        opendera_types::transport::http::HttpOutputConfig,
        ...
        opendera_types::transport::kafka::KafkaStartFromConfig,
        opendera_types::transport::nats::Auth,
        ...
        opendera_types::transport::pubsub::PubSubInputConfig,
        ...
        opendera_types::transport::delta_table::DeltaTableTransactionMode,
        ...
        opendera_types::transport::iceberg::IcebergReaderConfig,
        opendera_types::transport::iceberg::IcebergIngestMode,
        opendera_types::transport::iceberg::IcebergCatalogType,
        opendera_types::transport::iceberg::RestCatalogConfig,
        opendera_types::transport::iceberg::GlueCatalogConfig,
        opendera_types::transport::postgres::PostgresReaderConfig,
        opendera_types::transport::postgres::PostgresCdcReaderConfig,
        opendera_types::transport::postgres::PostgresWriterConfig,
        opendera_types::transport::postgres::PostgresWriteMode,
        opendera_types::transport::postgres::PostgresTlsConfig,
        opendera_types::transport::redis::RedisOutputConfig,
        opendera_types::transport::http::Chunk,
        opendera_types::transport::clock::ClockConfig,
        opendera_types::query::AdhocQueryArgs,
        opendera_types::query::AdHocResultFormat,
        opendera_types::format::json::JsonUpdateFormat,
        opendera_types::format::json::JsonLines,
        opendera_types::preprocess::PreprocessorConfig,
        opendera_types::program_schema::ProgramSchema,
        opendera_types::program_schema::Relation,
        opendera_types::program_schema::SqlType,
        opendera_types::program_schema::Field,
        opendera_types::program_schema::ColumnType,
        ...
        opendera_types::program_schema::SqlIdentifier,
        opendera_types::query_params::MetricsFormat,
        opendera_types::query_params::MetricsParameters,
        opendera_types::error::ErrorResponse,
        opendera_types::completion_token::CompletionTokenResponse,
        opendera_types::completion_token::CompletionStatusArgs,
        opendera_types::completion_token::CompletionStatus,
        opendera_types::completion_token::CompletionStatusResponse,
        opendera_types::checkpoint::CheckpointStatus,
        opendera_types::checkpoint::CheckpointSyncStatus,
        opendera_types::checkpoint::CheckpointResponse,
        opendera_types::checkpoint::CheckpointActivity,
        opendera_types::checkpoint::CheckpointFailure,
        opendera_types::checkpoint::CheckpointSyncFailure,
        opendera_types::checkpoint::CheckpointMetadata,
        opendera_types::preprocess::PreprocessorConfig,
        opendera_types::transaction::StartTransactionResponse,
        opendera_types::transaction::CommitProgressSummary,
        opendera_types::time_series::TimeSeries,
        opendera_types::time_series::SampleStatistics,
        opendera_types::suspend::SuspendError,
        opendera_types::suspend::PermanentSuspendError,
        opendera_types::suspend::TemporarySuspendError,

        // Adapter statistics
        opendera_types::adapter_stats::ExternalControllerStatus,
        opendera_types::memory_pressure::MemoryPressure,
        opendera_types::adapter_stats::ExternalGlobalControllerMetrics,
        opendera_types::adapter_stats::ConnectorError,
        opendera_types::adapter_stats::ConnectorHealth,
        opendera_types::adapter_stats::ConnectorHealthStatus,
        opendera_types::adapter_stats::ExternalInputEndpointStatus,
        opendera_types::adapter_stats::ExternalInputEndpointMetrics,
        opendera_types::adapter_stats::ExternalOutputEndpointStatus,
        opendera_types::adapter_stats::ExternalOutputEndpointMetrics,
        opendera_types::adapter_stats::CompletedWatermark,
        opendera_types::adapter_stats::ExternalTransactionInitiators,
        opendera_types::adapter_stats::ExternalTransactionPhase,
        opendera_types::adapter_stats::ExternalConnectorTransactionPhase,
        opendera_types::adapter_stats::PipelineState,
        opendera_types::adapter_stats::ShortEndpointConfig,
        opendera_types::adapter_stats::TransactionStatus,
