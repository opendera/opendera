...
use opendera_types::serde_with_context::serde_config::{BinaryFormat, DecimalFormat, UuidFormat};
...
/// the [`serialize_table_record`](opendera_types::serialize_table_record) macro and configured
...
mod test {
    ...
    use opendera_sqllib::{Date, SqlDecimal, Timestamp};
    use opendera_types::{serde_with_context::SerializeWithContext, serialize_table_record};
    use serde::Serialize;
